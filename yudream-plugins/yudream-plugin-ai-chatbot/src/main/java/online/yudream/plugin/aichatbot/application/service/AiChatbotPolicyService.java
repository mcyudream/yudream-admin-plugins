...
public class AiChatbotPolicyService {
    ...
    private Map<String, Object> toDocument(AiChatbotGroupPolicy p) {
        ...
        v.put("profileAnalysisMessageCount", p.profileAnalysisMessageCount());
        v.put("profileAutoAnalysisIntervalMinutes", p.profileAutoAnalysisIntervalMinutes());
        v.put("groupToolOpenAccess", p.groupToolOpenAccess());
