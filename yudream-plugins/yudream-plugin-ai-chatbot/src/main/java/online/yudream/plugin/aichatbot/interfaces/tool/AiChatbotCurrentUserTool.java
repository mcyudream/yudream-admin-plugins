...
public class AiChatbotCurrentUserTool implements PluginAiTool {
    ...
    @Override public PluginAiToolDescriptor descriptor() { return new PluginAiToolDescriptor(NAME, "查询当前 QQ 账号", "查询当前发言 QQ 绑定的系统账号和角色", "", PluginAiToolRisk.READ, false, Set.of("MENTION", "RANDOM"), Map.of()); }
