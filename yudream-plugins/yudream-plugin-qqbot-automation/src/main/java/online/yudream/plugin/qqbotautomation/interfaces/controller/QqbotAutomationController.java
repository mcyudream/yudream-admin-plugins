...
public class QqbotAutomationController {
    ...
    @PluginHttpEndpoint(method = "PUT", path = "/admin/group-aliases", permission = QqbotAutomationPlugin.MANAGE_PERMISSION) public PluginHttpResponse saveGroupAlias(PluginHttpRequest request) { return http.saveGroupAlias(request); }
    @PluginHttpEndpoint(method = "POST", path = "/admin/group-aliases/identify", permission = QqbotAutomationPlugin.MANAGE_PERMISSION) public PluginHttpResponse identifyGroup(PluginHttpRequest request) { return http.identifyGroup(request); }
    ...
    @PluginHttpEndpoint(method = "GET", path = "/admin/options/users", permission = QqbotAutomationPlugin.MANAGE_PERMISSION) public PluginHttpResponse users(PluginHttpRequest request) { return http.users(request); }
    ...
    @PluginHttpEndpoint(method = "GET", path = "/admin/media-settings", permission = QqbotAutomationPlugin.MANAGE_PERMISSION) public PluginHttpResponse mediaSettings() { return http.mediaSettings(); }
    @PluginHttpEndpoint(method = "PUT", path = "/admin/media-settings", permission = QqbotAutomationPlugin.MANAGE_PERMISSION) public PluginHttpResponse saveMediaSettings(PluginHttpRequest request) { return http.saveMediaSettings(request); }
}
