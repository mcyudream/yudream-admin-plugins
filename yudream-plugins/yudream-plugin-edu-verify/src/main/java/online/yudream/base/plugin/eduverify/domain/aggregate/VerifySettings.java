...
public record VerifySettings(
    ...
    public static VerifySettings defaults() {
        return new VerifySettings(true, true, true, 10, 60, 6, 365, 30, 5, null, Map.of(),
                ...
                "# 学信网在线验证码\n\n1. 在学信网申请《学籍在线验证报告》或《学历证书电子注册备案表》。\n2. 填写报告中的 16 位在线验证码。系统会读取官方报告页，并从报告中截取姓名和学校。\n3. 若管理员开启了邮件二次确认：请在学信网报告页使用官方「发送到邮箱」按钮，把报告发到站点指定的收件邮箱。不要让他人代发，也不要自行转发。系统会核对发件域，并从邮件正文或 PDF 附件抽取验证码与用户填写的码比对，两步都通过后才可注册。\n4. 官方报告页读取失败时可转入人工审核，届时再填写姓名、学校并补充证明材料。",
