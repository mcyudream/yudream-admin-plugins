...
const form = reactive<PolicyForm>({ connectionId: '', channelId: '', enabled: true, randomProbability: 0.03, groupContextLimit: 12, personalContextLimit: 16, contextExpansionLimit: 12, cooldownSeconds: 30, hourlyReplyLimit: 30, quietHoursStart: '', quietHoursEnd: '', systemPrompt: '你是 YuDream 群聊助手，回答简短、友好、准确。', persona: '', randomToolCallingEnabled: false, longTermMemoryEnabled: false, semanticMemoryTopK: 5, agentCode: 'builtin-group-chatbot', providerCode: '', modelCode: '', profileProviderCode: '', profileModelCode: '', profileAnalysisMessageCount: 20, profileAutoAnalysisIntervalMinutes: 0, mentionReplyInjection: '' })
