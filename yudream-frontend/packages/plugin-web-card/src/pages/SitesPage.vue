...
<style scoped>
.status-toggle,.row-actions,.test-actions{display:flex;align-items:center;flex-wrap:wrap;gap:8px}.status-toggle small,.column-heading small,.field small,.switch-row small,.route-item small{color:var(--color-text-3)}.pattern-cell{display:block;max-width:420px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.rule-workspace{display:grid;grid-template-columns:340px 260px minmax(620px,1fr);height:100%;min-height:0;background:var(--color-fill-1)}.workspace-column,.route-sidebar{min-width:0;overflow-y:auto;padding:24px}.site-column{border-right:1px solid var(--color-border-2);background:var(--color-bg-2)}.route-sidebar{display:flex;flex-direction:column;gap:16px;border-right:1px solid var(--color-border-2);background:var(--color-fill-1)}.editor-column{display:flex;flex-direction:column;gap:18px;background:var(--color-fill-1)}.column-heading{display:grid;gap:5px}.column-heading h3{margin:0;font-size:16px}.column-heading small,.field small,.switch-row small{line-height:1.5}.field{display:grid;gap:7px;margin-top:18px}.route-sidebar-head,.editor-header,.field-section-head{display:flex;align-items:flex-start;justify-content:space-between;gap:16px}.route-list{display:grid;gap:8px}.route-item{display:flex;width:100%;align-items:center;justify-content:space-between;gap:12px;border:1px solid var(--color-border-2);border-radius:6px;background:var(--color-bg-2);padding:12px;text-align:left}.route-item:hover,.route-item.active{border-color:rgb(var(--success-6));background:color-mix(in srgb,rgb(var(--success-6)) 8%,var(--color-bg-2))}.route-item span{display:grid;min-width:0;gap:4px}.route-item strong,.route-item small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.route-item i{width:8px;height:8px;flex:none;border-radius:50%;background:var(--color-border-3)}.route-item i.enabled{background:rgb(var(--success-6))}.switch-row{display:flex;align-items:center;gap:12px;margin-top:18px;padding:12px;border:1px solid var(--color-border-2);background:var(--color-fill-1)}.switch-row div{display:grid;gap:2px}.switch-row.compact{margin:0;background:var(--color-bg-2)}.rule-basics{display:grid;grid-template-columns:minmax(160px,.8fr) minmax(240px,1.3fr) minmax(180px,1fr) 150px;gap:12px;align-items:end}.rule-basics .field{margin:0}.parser-head,.parser-row{display:grid;grid-template-columns:minmax(90px,.75fr) minmax(160px,1.6fr) minmax(110px,.85fr) minmax(90px,.65fr) 36px;gap:10px;align-items:center}.parser-head{padding:0 12px;color:var(--color-text-3);font-size:12px}.parser-list{display:grid;gap:10px;overflow-x:auto}.parser-row{padding:12px;border:1px solid var(--color-border-2);border-radius:6px;background:var(--color-bg-2)}.test-panel{display:grid;grid-template-columns:minmax(280px,1fr) auto;gap:12px;align-items:end;margin-top:auto;padding-top:18px;border-top:1px solid var(--color-border-2)}.test-url{margin:0}.test-panel pre{grid-column:1/-1;max-height:260px;overflow:auto;border:1px solid var(--color-border-2);border-radius:6px;background:var(--color-bg-2);padding:12px;font-size:12px;line-height:1.55;white-space:pre-wrap}
@media(max-width:820px){.rule-workspace{display:block;overflow-y:auto}.workspace-column,.route-sidebar{overflow:visible;padding:18px}.route-sidebar{border-right:0;border-bottom:1px solid var(--color-border-2)}.route-list{grid-template-columns:repeat(2,minmax(0,1fr))}.editor-column{min-height:720px}.rule-basics,.parser-row,.test-panel{grid-template-columns:1fr}.parser-row>*:nth-child(2),.test-panel pre{grid-column:auto}}
@media (max-width:1280px){.rule-workspace{grid-template-columns:1fr;height:auto;max-height:calc(100dvh - 148px);overflow-y:auto}.workspace-column,.route-sidebar{overflow:visible;padding:16px}.site-column,.route-sidebar{border-right:0;border-bottom:1px solid var(--color-border-2)}.route-list{max-height:260px;overflow-y:auto}.rule-basics{grid-template-columns:repeat(2,minmax(0,1fr))}.parser-head{display:none}.parser-row{grid-template-columns:1fr}.test-panel{grid-template-columns:1fr}.test-actions{justify-content:flex-start}}
@media (max-width:640px){.workspace-column,.route-sidebar{padding:12px}.route-sidebar-head,.editor-header,.field-section-head{align-items:stretch;flex-direction:column}.route-sidebar-head>:last-child,.editor-header>:last-child,.field-section-head>:last-child{align-self:flex-start}.rule-basics{grid-template-columns:1fr}.switch-row{align-items:flex-start;flex-direction:column}.test-actions>*{flex:1}.pattern-cell{max-width:100%}}
</style>
