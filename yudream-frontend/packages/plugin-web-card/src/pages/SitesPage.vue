...
@media (max-width:1180px){.rule-workspace{grid-template-columns:1fr;height:auto;max-height:calc(100dvh - 148px);overflow-y:auto}.workspace-column,.route-sidebar{overflow:visible;padding:16px}.site-column,.route-sidebar{border-right:0;border-bottom:1px solid #dfe4e8}.route-list{max-height:260px;overflow-y:auto}.rule-basics{grid-template-columns:repeat(2,minmax(0,1fr))}.parser-head{display:none}.parser-row{grid-template-columns:1fr}.test-panel{grid-template-columns:1fr}.test-actions{justify-content:flex-start}}
