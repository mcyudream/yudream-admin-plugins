...
<style scoped>
.studio-shell{--studio-border:var(--color-border-2);--studio-muted:var(--color-text-3);--studio-soft:var(--color-fill-1);--studio-accent:rgb(var(--primary-6));background:var(--color-bg-1);min-height:calc(100vh - 56px)}
.studio-main{padding-top:20px}.studio-grid{display:grid;grid-template-columns:220px minmax(420px,1fr) 400px;min-height:680px;border:1px solid var(--studio-border);background:var(--color-bg-2)}
.header-actions{display:flex;flex-wrap:wrap;gap:8px}.studio-link{display:inline-flex;min-height:34px;align-items:center;gap:6px;border:1px solid var(--studio-border);background:var(--color-bg-2);padding:0 11px;color:var(--color-text-2);text-decoration:none;font-size:13px}.studio-link:hover{border-color:rgb(var(--primary-6));background:var(--color-fill-1);color:rgb(var(--primary-6))}.session-rail{border-right:1px solid var(--studio-border);padding:20px 12px;background:var(--color-fill-1)}.rail-title{padding:0 10px 12px;color:var(--studio-muted);font-size:12px;font-weight:700;text-transform:uppercase}.session-item{position:relative;display:flex;align-items:stretch}.session-item:hover,.session-item.active{background:var(--color-fill-2)}.session-row{display:flex;min-width:0;flex:1;gap:10px;align-items:flex-start;border:0;background:transparent;padding:12px 36px 12px 10px;text-align:left;color:var(--color-text-1);cursor:pointer}.session-row>svg{margin-top:2px;color:var(--color-text-3)}.session-row span{display:grid;gap:4px;min-width:0}.session-row strong{font-size:14px}.session-row small{color:var(--studio-muted);font-size:11px}.session-delete{position:absolute;top:50%;right:7px;display:grid;width:28px;height:28px;transform:translateY(-50%);place-items:center;border:0;background:transparent;color:var(--color-text-3);cursor:pointer;opacity:0}.session-item:hover .session-delete,.session-item.active .session-delete,.session-delete:focus-visible{opacity:1}.session-delete:hover{color:rgb(var(--danger-6))}.session-delete:disabled{cursor:not-allowed;opacity:.4}
.conversation-pane{display:grid;grid-template-rows:minmax(0,1fr) auto;min-width:0}.conversation-stream{max-height:620px;overflow:auto;padding:28px 32px}.welcome-state{display:grid;min-height:360px;place-items:center;align-content:center;text-align:center;color:var(--studio-muted);gap:10px}.welcome-state>svg{font-size:34px;color:var(--studio-accent)}.welcome-state h2{margin:4px 0 0;color:var(--color-text-1);font-size:22px}.welcome-state p{max-width:520px;margin:0;line-height:1.7}.turn{max-width:760px;margin-bottom:24px}.turn-author{display:flex;align-items:center;gap:8px;margin-bottom:7px;color:var(--studio-muted);font-size:12px;font-weight:700}.turn-author small{color:rgb(var(--success-6))}.turn-body{border-left:3px solid var(--color-border-3);padding:12px 16px;background:var(--studio-soft);line-height:1.7;white-space:pre-wrap}.turn.assistant .turn-body{border-left-color:rgb(var(--success-6));background:color-mix(in srgb,rgb(var(--success-6)) 8%,var(--color-bg-2))}.agent-turn{white-space:normal}.streaming-turn .turn-author small::before{display:inline-block;width:6px;height:6px;margin-right:5px;border-radius:50%;background:rgb(var(--success-6));content:'';animation:pulse 1.2s infinite}.composer{border-top:1px solid var(--studio-border);padding:20px 24px}.composer-footer{display:flex;justify-content:space-between;align-items:center;gap:16px;margin-top:12px}.composer-footer span{color:var(--studio-muted);font-size:12px}
.inspector-pane{border-left:1px solid var(--studio-border);background:var(--color-fill-1);overflow:auto}.inspector-section{padding:22px 20px;border-bottom:1px solid var(--studio-border)}.section-heading{display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;color:var(--color-text-1);font-size:14px;font-weight:700}.section-heading small{color:rgb(var(--success-6));font-size:11px}.proposal-artifact{margin-bottom:18px}.proposal-editor{display:grid;gap:22px}.editor-group{display:grid;gap:12px;padding-top:18px;border-top:1px solid var(--color-border-2)}.editor-group:first-child{padding-top:0;border-top:0}.editor-group h3{display:flex;align-items:center;gap:8px;margin:0;color:var(--color-text-1);font-size:13px}.editor-group h3 svg{color:var(--color-text-3)}.group-heading,.setting-row,.parser-field-heading{display:flex;align-items:center;justify-content:space-between;gap:12px}.field{display:grid;gap:6px}.field label{font-size:12px;color:var(--color-text-2)}.parser-field{display:grid;gap:10px;padding:13px;border:1px solid var(--color-border-2);background:var(--color-bg-2)}.parser-field-heading strong{font-size:12px}.setting-row>span{display:grid;gap:3px;min-width:0}.setting-row strong{font-size:13px}.setting-row small,.inspector-empty{color:var(--studio-muted);font-size:12px;line-height:1.5}.crawl-group{padding-bottom:4px}.inspector-empty{padding:20px 0}.action-row{position:sticky;bottom:0;z-index:2;display:flex;flex-wrap:wrap;justify-content:flex-end;gap:8px;margin:22px -20px -22px;padding:14px 20px;border-top:1px solid var(--studio-border);background:color-mix(in srgb,var(--color-bg-2) 94%,transparent);backdrop-filter:blur(12px)}
.proposal-code-field{min-width:0}.agent-preview-toolbar{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;margin-bottom:12px}.card-preview{display:grid;min-height:210px;place-items:center;border:1px solid var(--studio-border);background:var(--color-fill-1);padding:14px}.card-preview img{display:block;max-width:100%;height:auto}.card-preview>div{width:100%;background:var(--color-bg-2);border:1px solid var(--color-border-2);padding:20px}.card-preview strong{font-size:17px}.card-preview p{margin:9px 0 0;color:var(--studio-muted);font-size:13px;line-height:1.6}.preview-fields{display:grid;gap:8px;margin-top:12px}.preview-fields>span{display:grid;grid-template-columns:80px minmax(0,1fr);gap:10px;padding-bottom:8px;border-bottom:1px solid var(--studio-border)}.preview-fields small{color:var(--studio-muted)}.preview-fields strong{overflow:hidden;text-overflow:ellipsis;font-size:12px;font-weight:500;white-space:nowrap}.secret-section{display:grid;gap:12px}.secret-section .section-heading{margin-bottom:4px}.mobile-switcher{display:none}
...
@media(max-width:1320px){.studio-grid{grid-template-columns:180px minmax(400px,1fr) 400px}.conversation-stream{padding:24px}}
@media(max-width:1100px){.studio-shell{min-height:calc(100dvh - 56px);background:var(--color-bg-1)}.studio-header{background:var(--color-bg-2)}.studio-main{padding-top:12px}.mobile-switcher{position:sticky;top:8px;z-index:5;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:4px;margin-bottom:12px;padding:4px;border:1px solid var(--studio-border);background:color-mix(in srgb,var(--color-bg-2) 94%,transparent);box-shadow:0 5px 18px rgba(0,0,0,.08);backdrop-filter:blur(12px)}.mobile-switcher button{position:relative;display:flex;min-width:0;height:42px;align-items:center;justify-content:center;gap:7px;border:0;background:transparent;color:var(--color-text-2);font:inherit;font-size:13px;font-weight:650;cursor:pointer}.mobile-switcher button.active{background:var(--color-fill-2);color:rgb(var(--primary-6))}.mobile-switcher button:focus-visible{outline:2px solid rgb(var(--primary-6));outline-offset:-2px}.mobile-switcher svg{font-size:17px}.mobile-switcher .pending-dot{position:absolute;top:8px;right:calc(50% - 30px);width:6px;height:6px;border-radius:50%;background:rgb(var(--danger-6))}.studio-grid{display:block;min-height:0;border:0;background:transparent}.session-rail{display:none}.conversation-pane,.inspector-pane{display:none}.conversation-pane.mobile-visible{display:grid;min-height:clamp(500px,calc(100dvh - 205px),720px);border:1px solid var(--studio-border);background:var(--color-bg-2)}.conversation-stream{min-height:0;max-height:none;padding:20px 18px;overscroll-behavior:contain}.welcome-state{min-height:240px;padding:16px 4px;gap:8px}.welcome-state>svg{font-size:28px}.welcome-state h2{font-size:18px;line-height:1.4}.welcome-state p{font-size:13px;line-height:1.6}.turn{margin-bottom:18px}.turn-body{padding:10px 12px;font-size:14px;line-height:1.65}.composer{padding:12px;border-top-color:var(--color-border-2);background:var(--color-fill-1)}.composer-footer{justify-content:flex-end;margin-top:10px}.composer-footer span{display:none}.inspector-pane.mobile-visible{display:block;min-height:clamp(500px,calc(100dvh - 205px),720px);border:1px solid var(--studio-border);background:var(--color-bg-2);overflow:visible}.inspector-pane.mobile-plan .preview-section{display:none}.inspector-pane.mobile-preview .plan-section,.inspector-pane.mobile-preview .secret-section{display:none}.inspector-section{padding:20px 18px}.inspector-pane.mobile-visible .inspector-section:last-child{border-bottom:0}.section-heading{margin-bottom:18px;font-size:15px}.action-row{margin-right:-18px;margin-bottom:-20px;margin-left:-18px;padding:12px 18px;flex-wrap:wrap}.preview-section{padding:18px}.card-preview{min-height:320px;padding:12px}}
@media(max-width:1100px){.studio-grid{height:auto;overflow:visible}}
