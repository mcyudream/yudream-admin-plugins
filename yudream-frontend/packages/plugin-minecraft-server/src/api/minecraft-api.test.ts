...
describe('minecraft API', () => {
  ...
  it('uses the supplied map endpoints and blob downloads', () => {
    ...
    api.saveMapLink('a/b', 'https://pan.example/s/abc', 'S1 存档')
    ...
    expect(sdk.http.post).toHaveBeenCalledWith('/admin/servers/a%2Fb/map/link', { url: 'https://pan.example/s/abc', originalName: 'S1 存档' })
