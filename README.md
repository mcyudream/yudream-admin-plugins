...
- ✅ **独立发布链路**：支持将插件 JAR 发布到 GitLab Generic Package Registry，并在发布后回读校验。
...
- Maven 从主体仓 GitLab Maven Registry 获取 SPI
- npm 从 npmjs 获取 `@yudream/*`
- 如需私有 npm 路径，可切换到主体仓 GitLab npm Registry
...
- 将插件 JAR 发布到本仓 GitLab Generic Package Registry
